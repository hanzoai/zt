...
import (
	...
	"github.com/hanzozt/zt/zttest/models/smart/actions"
	ztlab_actions "github.com/hanzozt/zt/zttest/ztlab/actions"
	"github.com/hanzozt/zt/zttest/ztlab/console"
)
...
func (_ *actionsFactory) Build(m *model.Model) error {
	m.Actions = model.ActionBinders{
		...
		"logs":      func(m *model.Model) model.Action { return ztlab_actions.Logs() },
	}
	return nil
}
