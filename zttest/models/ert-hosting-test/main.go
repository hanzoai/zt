...
var m = &model.Model{
	...
	Actions: model.ActionBinders{
		"createHostConfig": model.Bind(ztlib_actions.Edge("create", "config", "host-config", "host.v1", `
				{
					"address" : "localhost",
					"port" : 8080,
					"protocol" : "tcp"
		...
		"bootstrap": model.ActionBinder(func(m *model.Model) model.Action {
			...
			workflow.AddAction(edge.InitEdgeRoutersWithClients(models.RouterTag, 50, func(r model.Run) (*ztrest.Clients, error) {
