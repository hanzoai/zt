...
func createNewPostureCheck(ctrl *ztrest.Clients) parallel.LabeledTask {
...
func createNewService(ctrl *ztrest.Clients, configs []string) parallel.LabeledTask {
...
func createNewConfigType(ctrl *ztrest.Clients) parallel.LabeledTask {
...
func createNewConfig(ctrl *ztrest.Clients, configTypeId string) parallel.LabeledTask {
...
func createNewIdentity(ctrl *ztrest.Clients) parallel.LabeledTask {
	isAdmin := false
...
func createNewServicePolicy(ctrl *ztrest.Clients) parallel.LabeledTask {
...
func validateRouterDataModelForCtrlOnce(id string, clients *ztrest.Clients) (int, error) {
