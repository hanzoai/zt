...
func (d dbStrategy) PostProcess(router *db.EdgeRouter, c *model.Component) {
	...
	c.Type.(*ztlab.RouterType).Version = TargetZitiVersion
}
...
func (d dbStrategy) CreateIdentityHosts(tx *bbolt.Tx, m *model.Model, builder *ztlab.ZitiDbBuilder) error {
