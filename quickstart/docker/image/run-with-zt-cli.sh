...
# give the controller scripts time to start and create the zt environment file if running in docker compose 
until $(test -f "${ZITI_HOME}/zt.env"); do echo "waiting for zt.env..."; sleep 1; done
