...
func outputHeader(o *policyAdvisorOptions) error {
	...
	_, err := fmt.Fprintf(o.Out, "\n"+
		...
		"    - See edge router polices for an identity: zt edge controller list identity edge-router-policies <identity>\n"+
		"  SVC = service name\n"+
		"  SVC ROUTERS = number of routers accessible to the service via service edge router policies.\n"+
		"    - See service edge router policies for a service with: zt edge controller list service service-edge-router-policies <service>\n"+
		...
		"    - See service polices for a service  : zt edge controller list service service-policies <service>\n"+
		"    - See service polices for an identity: zt edge controller list identity service-policies <identity>\n"+
