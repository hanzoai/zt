...
type ztEchoServer struct {
	identityJson string
	listener     net.Listener
}

func (s *ztEchoServer) ServeHTTP(rw http.ResponseWriter, r *http.Request) {
...
func (s *ztEchoServer) run() (err error) {
	config, err := zt.NewConfigFromFile(s.identityJson)
	if err != nil {
		return err
	}
	...
	if s.listener, err = ztContext.Listen("echo"); err != nil {
		return err
	}
...
func (s *ztEchoServer) stop() error {
