...
* github.com/hanzozt/ziti: [v0.34.1 -> v0.34.2](https://github.com/hanzozt/ziti/compare/v0.34.1...v0.34.2)
    * [Issue #1831](https://github.com/hanzozt/ziti/issues/1831) - Circuit ID should be returned in the response to a Dial request
    * [Issue #1873](https://github.com/hanzozt/ziti/issues/1873) - host.v1 health check time.Duration unconvertible
...
* github.com/hanzozt/ziti: [v0.33.1 -> v0.34.0](https://github.com/hanzozt/ziti/compare/v0.33.1...v0.34.0)
    * [Issue #1858](https://github.com/hanzozt/ziti/issues/1858) - add option to create a generic env file instead of a BASH script
    * [Issue #1428](https://github.com/hanzozt/ziti/issues/1428) - Investigate policy integrity performance
    * [Issue #1854](https://github.com/hanzozt/ziti/issues/1854) - Controller can try to send unroute to router which has since disconnected, causing panic
    * [Issue #1576](https://github.com/hanzozt/ziti/issues/1576) - Don't scan for posture checks if there are no posture checks 
    * [Issue #1849](https://github.com/hanzozt/ziti/issues/1849) - Session Sync shouldn't be able to block the control channel
    * [Issue #1846](https://github.com/hanzozt/ziti/issues/1846) - Looking up api session certs for api sessions is inefficient
