...
The event types are now exhaustively documented as part of the [Hanzo ZT Reference Documentation](https://hanzozt.dev/docs/reference/events).
...
* github.com/hanzozt/agent: [v1.0.23 -> v1.0.26](https://github.com/hanzozt/agent/compare/v1.0.23...v1.0.26)
* github.com/hanzozt/channel/v3: [v3.0.26 -> v3.0.37](https://github.com/hanzozt/channel/compare/v3.0.26...v3.0.37)
    * [Issue #168](https://github.com/hanzozt/channel/issues/168) - Add DisconnectHandler to reconnecting channel

* github.com/hanzozt/edge-api: [v0.26.38 -> v0.26.41](https://github.com/hanzozt/edge-api/compare/v0.26.38...v0.26.41)
* github.com/hanzozt/foundation/v2: [v2.0.56 -> v2.0.58](https://github.com/hanzozt/foundation/compare/v2.0.56...v2.0.58)
* github.com/hanzozt/identity: [v1.0.94 -> v1.0.100](https://github.com/hanzozt/identity/compare/v1.0.94...v1.0.100)
* github.com/hanzozt/metrics: [v1.2.65 -> v1.2.69](https://github.com/hanzozt/metrics/compare/v1.2.65...v1.2.69)
* github.com/hanzozt/runzmd: [v1.0.59 -> v1.0.65](https://github.com/hanzozt/runzmd/compare/v1.0.59...v1.0.65)
* github.com/hanzozt/sdk-golang: [v0.23.44 -> v0.24.1](https://github.com/hanzozt/sdk-golang/compare/v0.23.44...v0.24.1)
...
* github.com/hanzozt/secretstream: [v0.1.28 -> v0.1.31](https://github.com/hanzozt/secretstream/compare/v0.1.28...v0.1.31)
* github.com/hanzozt/storage: [v0.3.15 -> v0.4.5](https://github.com/hanzozt/storage/compare/v0.3.15...v0.4.5)
    * [Issue #94](https://github.com/hanzozt/storage/issues/94) - Snapshots aren't working correctly

* github.com/hanzozt/transport/v2: [v2.0.159 -> v2.0.165](https://github.com/hanzozt/transport/compare/v2.0.159...v2.0.165)
