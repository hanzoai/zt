...
This is the next major version release of Hanzo ZT, following the 1.0 release in April 2024. 
...
when running HA. Legacy API and service session are now deprecated and will be removed in the Hanzo ZT v3.0.0 release. 
...
Controller APIs can now be bound to an Hanzo ZT overlay network identity, allowing secure communication through
...
To bind controller APIs to an Hanzo ZT identity, add an additional `identity` block to your `bindPoints`. The
...
Hanzo ZT now supports provisioning identities just-in-time through OIDC/JWT token enrollment. External identity 
...
* github.com/hanzozt/edge-api: [v0.26.50 -> v0.26.52](https://github.com/hanzozt/edge-api/compare/v0.26.50...v0.26.52)
...
* github.com/hanzozt/runzmd: [v1.0.84 -> v1.0.86](https://github.com/hanzozt/runzmd/compare/v1.0.84...v1.0.86)
* github.com/hanzozt/sdk-golang: [v1.2.10 -> v1.3.1](https://github.com/hanzozt/sdk-golang/compare/v1.2.10...v1.3.1)
...
* github.com/hanzozt/secretstream: [v0.1.41 -> v0.1.46](https://github.com/hanzozt/secretstream/compare/v0.1.41...v0.1.46)
* github.com/hanzozt/storage: [v0.4.31 -> v0.4.35](https://github.com/hanzozt/storage/compare/v0.4.31...v0.4.35)
    * [Issue #122](https://github.com/hanzozt/storage/issues/122) - StringFuncNode has incorrect nil check, allowing panic
    * [Issue #120](https://github.com/hanzozt/storage/issues/120) - Change post tx commit constraint handling order
    * [Issue #119](https://github.com/hanzozt/storage/issues/119) - Add ContextDecorator API
